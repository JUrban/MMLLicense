...
\begin{center}
\sc\small Copyright (C) 2002-2007 FSFE, e.V. (Düsseldorf, Germany),\\
\sc\small Copyright (C) 2010 Association of Mizar Users (Białystok, Poland),\\
...
Articles, under (one or more) share-alike (copyleft) licenses in the
spirit of GPL, GFDL, and CC-BY-SA. In parallel, AMU is also allowed to
